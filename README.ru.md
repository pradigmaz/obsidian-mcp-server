<div align="center">
  ...
  <p>
    <i>Проект основан на <a href="https://github.com/cyanheads/obsidian-mcp-server">cyanheads/obsidian-mcp-server</a>. Базовые возможности чтения и записи заметок сохранены; поверх них добавлены инструменты поиска, диагностики графа и Knowledge Analytics для хранилищ Obsidian. Базовую архитектуру сервера создали оригинальные авторы.</i>
  </p>
